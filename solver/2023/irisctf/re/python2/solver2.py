...
def unscramble1(flag):
    arr = [16,37,42,0,2,7,30,14,10,24,9,23,17,25,38,5,4,41,15,28,11,47,35,43,20,44,6,1,36,31,34,39,27,18,8,13,46,3,32,12,33,48,40,45,29,49,19,26,22,21,50]
    for pos in arr[::-1]:
        if pos == 0:
...
def unscramble2(flag):
    arr = [3,26,37,38,41,32,39,44,22,20,36,9,30,1,4,48,0,19,10,2,25,21,28,42,34,31,43,7,13,46,11,35,47,45,49,16,18,6,14,40,15,27,24,17,23,5,29,8,12,33,50]
    # while True:
    for pos in arr[::-1]:
        if pos == 0:
