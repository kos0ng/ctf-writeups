...
def encrypt(block, key):
    ...
    for r in range(ROUNDS):
        ...
        temp = bytearray(8)
        # print("ct_block bef",r,block)
        for i in range(8):
            for j in range(8):
                temp[j] |= ((block[i] >> TRANSPOSE[i][j]) & 1) << i
        # print("ct_block aft",r,temp)
        block = temp
...
print(f"key: {key.hex()}")
ct = bytes.fromhex("efb6d7f1a2ddefdd04567cedb6d2a6c5fa8b96ad26f92fb1b0b55ad6a13838c6")
print(ecb_dec(ct,key))
