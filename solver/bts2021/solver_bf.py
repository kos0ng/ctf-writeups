...
# 	print i
flag = "BtS-CTF{"
encode = "SGVyZSBpcyB5b3VyIHJld2FyZCBodHRwczovL3d3dy55b3V0dWJlLmNvbS93YXRjaD92PWo1YTBqVGM5UzEwLiBZb3Vy"
for i in range(99,len(possible)-1,4):
	# print(flag)
	first = possible[i]
	second = possible[i+1]
	third = possible[i+2]
	fourth = possible[i+3]
	print(i,first,second,third,fourth)
	for j in first:
		for k in second:
			for l in third:
				for m in fourth:
